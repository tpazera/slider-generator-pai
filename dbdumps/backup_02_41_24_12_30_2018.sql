...
INSERT INTO `blocks` VALUES (1,100,200,'red',30,30,2,21);
...
INSERT INTO `sliders` VALUES (95,'1My slider',300,4400,1);
...
CREATE TABLE `slides` (
  ...
  CONSTRAINT `slides_sliders_id_slider_fk` FOREIGN KEY (`id_slider`) REFERENCES `sliders` (`id_slider`) ON DELETE CASCADE
...
INSERT INTO `slides` VALUES (21,'#4377F0','default.png','cover',95),(22,'#4377F0','default.png','cover',95);
...
INSERT INTO `textblocks` VALUES (16,'<p>Hello world</p>',1,5,5,21),(17,'Hello world 2',3,15,15,21);
...
-- Dump completed on 2018-12-30  1:41:26
