...
CREATE TABLE `blocks` (
  ...
  CONSTRAINT `blocks_slides_id_slide_fk` FOREIGN KEY (`id_slide`) REFERENCES `slides` (`id_slide`)
...
CREATE TABLE `sliders` (
  ...
  CONSTRAINT `sliders_users_id_fk` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`)
...
INSERT INTO `sliders` VALUES (7,'Test',500,3000,1),(8,'Mojpierwszy',500,3000,1),(9,'Mojpierwszy',500,3000,1),(10,'Mojpierwszy',500,3000,1),(11,'Mojpierwszy',500,3000,1),(12,'Mojpierwszy',500,3000,1),(13,'Mojpierwszy',500,3000,1),(14,'Test',500,3000,1),(15,'Test',500,3000,1);
...
CREATE TABLE `slides` (
  ...
  CONSTRAINT `slides_sliders_id_slider_fk` FOREIGN KEY (`id_slider`) REFERENCES `sliders` (`id_slider`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `textblocks` (
  ...
  CONSTRAINT `textblocks_slides_id_slide_fk` FOREIGN KEY (`id_slide`) REFERENCES `slides` (`id_slide`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-12-28  1:30:41
